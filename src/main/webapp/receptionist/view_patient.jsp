						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="edit-patient?id=<%=patient.getPatientId()%>">Edit</a>
										&nbsp;&nbsp;&nbsp;&nbsp; <a
										href="delete-patient?id=<%=patient.getPatientId()%>" onclick="confirm('Are You Sure You Want to Delete Patient?')">Delete</a>
									</td>
								</tr>
								<%
									}
