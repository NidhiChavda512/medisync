...
<title>Meddical Records Patient List</title>
<%
...
<body>
	...
	<div class="col-3 ml-auto">
            <input type="text" id="searchInput" class="form-control" placeholder="Search Patient by Name or Email">
    </div>
    <script>
        ...
        function clearSearch() {
            ...
            $.ajax({
                url: "search-patient",
                type: "GET",
                data: { patientName: "" }, // Send an empty string to indicate all records
                success: function(response) {
		...
		<div class="row">
			<div class="col-md-9 mx-auto">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 fw-bold text-center text-success">Medical Records Patient List</p>
						<table class="table">
							<thead>
								<tr>
									...
									<th scope="col" colspan="2">Medical Records</th>
								</tr>
							</thead>
